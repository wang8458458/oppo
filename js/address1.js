$(function() {
	...
	// 	// 赋值省市区
	// 	new PCAS("province3", "city3", "area3", $(".province").text(), $(".city").text(), $(".area").text());
	// 	// $("select").eq(0).val($(this).parent().siblings(".new-address").find("span").eq(0).text())
	// 	//$("select").eq(1).val($(this).parent().siblings(".new-address").find("span").eq(1).text())



	// 	// 	// $("select").eq(1).val($(this).parent().siblings(".new-address span").eq(1).text())
	// 	// 	// $("select").eq(2).val($(this).parent().siblings(".new-address").find("span").eq(2).text())
